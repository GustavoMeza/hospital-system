// Returns a module to perform CRUD operations on inputs
// Dependencies:
...
module.exports = (connector) => ({
    create: (obj) => {
        ...
        var escapedValues = [obj.supplier, obj.address, obj.comments, obj.type, obj.status, obj.original_id, obj.created_at, obj.created_by];
    ...
    update: (obj) => {
        ...
        var escapedValues = [obj.supplier, obj.address, obj.comments, obj.type, obj.status, obj.original_id, obj.created_at, obj.created_by, obj.id];
        return connector.execute(sql, escapedValues);
    },
    delete: (id) => {
